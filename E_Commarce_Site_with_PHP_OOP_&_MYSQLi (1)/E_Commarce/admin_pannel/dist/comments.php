...
<html class="no-js" lang="">
    <head>
        ...
        <title>Admin Panel|| Comments Option</title>
                ...
                <section class="contentsection clear">
                    <aside class="leftsidebar clear">
                        <div class="samesidebar">
                            <h2>Theme Option</h2>
                            <ul>
                                <li><a href="update_social.html">Social option</a></li>
                         ...
                         <div class="samesidebar">
                            <h2>UI Option</h2>
                            <ul>
                                <li><a href="bg_change.html">Change Site Background</a></li>
                                <li><a href="font_change.html">Change Site Fonts</a></li>
                            </ul>
                        </div>
                         <div class="samesidebar">
                        ...
                        <div class="samesidebar">
                            ...
                            <ul>
                                ...
                                <li><a href="article_list.html">Article List</a></li>
                            </ul>
                        </div>
                    </aside>
                    <article class="maincontent clear">
                        <div class="content">
                            ...
                            <table class="mytable">
                                ...
                                <tr>
                                    <td>01.</td>
                                    <td>Comments will go here</td>
                                    <td><a href="" target="_blank">Article title</a></td>
                                    <td><a href="">Edit</a>||<a href="">Approve</a>||<a href="">Delete</a></td>
                                </tr>
                                <tr>
                                    <td>02.</td>
                                    <td>Comments will go here</td>
                            ...
                            <table class="mytable">
                                ...
                                <tr>
                                    ...
                                    <td>Comments will go here</td>
                                    <td><a href="" target="_blank">Article title</a></td>
                                    <td><a href="">Edit</a>||<a href="">Draft</a>||<a href="">Delete</a></td>
                                </tr>
                                <tr>
                                    <td>02.</td>
                                    <td>Comments will go here</td>
